...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex-col flex items-center justify-center">
      <h1 className="text-center mb-5 text-lg font-semibold">REGISTER AS ORGANIZER</h1>
